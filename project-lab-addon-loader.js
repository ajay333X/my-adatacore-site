(()=>{
  ...
  (async()=>{
    ...
    if(a.is_super_admin){for(const src of ['/project-lab-assignment-center.js?v=1','/project-lab-advanced-controls.js?v=1','/project-lab-operations-suite.js?v=1','/project-lab-transcription-settings.js?v=1','/project-lab-slack-channel.js?v=20260904-3'])await load(src);return}
